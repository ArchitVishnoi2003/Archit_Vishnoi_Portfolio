  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-5 sm:px-6 pt-28 md:pt-32 lg:pt-24 pb-16 md:pb-12 overflow-hidden w-full max-w-full">
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-12 lg:gap-8 items-center w-full">

          {/* Left Column: Text Content */}
          <div className="text-left animate-fade-in flex flex-col items-start lg:pl-4 min-w-0 w-full order-1">
            {/* Eyebrow */}
            ...
            {/* Hero Title */}
            <h1 className="font-serif text-[2.4rem] sm:text-[3.2rem] md:text-[4.5rem] lg:text-[5.5rem] leading-[1.05] tracking-tight text-foreground mb-5 sm:mb-6 animate-slide-up text-balance break-words">
          ...
          <div className="relative flex justify-center lg:justify-end animate-fade-in mt-2 sm:mt-8 lg:mt-0 lg:pr-12 w-full min-w-0 order-2" style={{ animationDelay: "0.4s" }}>
            <div className="relative w-[260px] h-[330px] sm:w-[300px] sm:h-[380px] md:w-[340px] md:h-[430px] lg:w-[380px] lg:h-[480px] mx-auto lg:mx-0 max-w-full">
              ...
              {/* Open to Work Badge */}
              <div className="absolute -top-3 right-2 sm:-top-4 sm:right-1 md:-top-4 md:-right-4 z-20 rotate-[12deg] hover:rotate-[15deg] transition-transform duration-300">
                <div className="bg-[#e4fc68] text-black font-bold uppercase tracking-widest text-[8px] sm:text-[9px] md:text-[10px] py-1 sm:py-1.5 px-2.5 sm:px-3.5 md:px-4 rounded-full border border-black/20 shadow-xl flex items-center gap-1 sm:gap-1.5">
                  <span className="text-[10px] sm:text-xs">✺</span> Open to Work <span className="text-[10px] sm:text-xs">✺</span>
                </div>
              </div>

              {/* Floating Tags Container */}
              <div className="absolute -bottom-2 left-0 right-0 h-24 sm:h-28 md:h-32 z-20 pointer-events-none">

                {/* Team Player Tag */}
                <div className="absolute bottom-0 sm:bottom-2 left-2 sm:left-1 rotate-[4deg] transition-transform duration-500 hover:rotate-0">
                  <div className="bg-[#1f1f1f] border border-white/5 text-[#e8e4dc] font-serif text-[11px] sm:text-xs md:text-base px-3 sm:px-4 md:px-6 py-1 sm:py-1.5 md:py-2.5 rounded-xl shadow-2xl drop-shadow-2xl opacity-95">
                    Team player
                  </div>
                </div>

                {/* Impact Oriented Tag */}
                <div className="absolute bottom-6 sm:bottom-8 left-[28%] sm:left-[32%] md:left-[38%] rotate-[22deg] transition-transform duration-500 hover:rotate-[15deg]">
                  <div className="bg-[#1f1f1f] border border-white/5 text-[#e8e4dc] font-serif text-[11px] sm:text-xs md:text-base px-3 sm:px-4 md:px-6 py-1 sm:py-1.5 md:py-2.5 rounded-xl shadow-2xl drop-shadow-2xl opacity-95">
                    Impact oriented
                  </div>
                </div>
                ...
                {/* Creative Tag */}
                <div className="absolute bottom-16 sm:bottom-20 md:bottom-24 right-2 sm:right-1 md:-right-2 rotate-[-5deg] transition-transform duration-500 hover:rotate-0">
                  <div className="bg-[#1f1f1f] border border-white/5 text-[#e8e4dc] font-serif text-[11px] sm:text-xs md:text-base px-3 sm:px-4 md:px-6 py-1 sm:py-1.5 md:py-2.5 rounded-xl shadow-2xl drop-shadow-2xl opacity-95">
                    Creative
                  </div>
                </div>
        ...
        {/* Scroll Cue */}
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce-subtle z-20 hidden lg:block">
