      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Combining product strategy with technical execution to deliver impactful solutions.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-xl bg-primary/20 flex items-center justify-center">
                <productSkills.icon className="h-6 w-6 text-primary" />
              </div>
              <h3 className="text-xl font-semibold text-foreground">{productSkills.title}</h3>
            </div>
            <div className="flex flex-wrap gap-2">
              {productSkills.tags.map((tag, index) => (
                <span
                  key={tag}
                  className="px-3 py-1.5 text-sm glass rounded-full text-muted-foreground hover:text-primary hover:border-primary/30 transition-colors cursor-default"
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-xl bg-primary/20 flex items-center justify-center">
                <developerSkills.icon className="h-6 w-6 text-primary" />
              </div>
              <h3 className="text-xl font-semibold text-foreground">{developerSkills.title}</h3>
            </div>
            <div className="flex flex-wrap gap-2">
