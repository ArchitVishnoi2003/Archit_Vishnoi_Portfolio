    ...
    return (
      <div className="glass rounded-2xl overflow-hidden font-mono text-sm">
        ...
        <div className="flex">
          ...
          {/* JSON editor */}
          <form onSubmit={handleSubmit} className="flex-1 p-4 space-y-0">
            ...
            <div className="leading-7 pl-4 flex items-center gap-1">
              ...
              <span className="text-muted-foreground">:</span>
              <span className="text-orange-400">{new Date().toISOString().split("T")[0]}</span>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <Link
                    href="mailto:avarchit123@gmail.com"
                    className="text-foreground hover:text-primary transition-colors"
                  >
                    avarchit123@gmail.com
                  </Link>
                </div>
              </div>
