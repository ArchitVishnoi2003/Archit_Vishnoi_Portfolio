...
export function About() {
  ...
  return (
    <section id="about" ref={sectionRef} className="py-12 md:py-16 px-6 md:px-12 lg:px-24 flex items-center min-h-screen">
      <div className="max-w-6xl mx-auto w-full">
        <div
          className={`grid lg:grid-cols-2 gap-8 lg:gap-12 items-center transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
        >
          {/* Left Content Side */}
